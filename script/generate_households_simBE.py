...
def get_age(rand, ratio):
    young_percentage = 0.122097841 * ratio / 100

    if rand < 0.054588418:
        return random.randint(0, 4)
    elif rand < 0.113220456:
        return random.randint(5, 9)
    elif rand < 0.169479634:
        return random.randint(10, 14)
    elif rand < 0.23472095:
        return random.randint(25, 29)
    elif rand < 0.298535913:
        return random.randint(30, 34)
    elif rand < 0.364400819:
        return random.randint(35, 39)
    elif rand < 0.428480322:
        return random.randint(40, 44)
    elif rand < 0.497300268:
        return random.randint(45, 49)
    elif rand < 0.568634443:
        return random.randint(50, 54)
    elif rand < 0.622480145:
        return random.randint(65, 69)
    elif rand < 0.667290784:
        return random.randint(70, 74)
    elif rand < 0.699959137:
        return random.randint(75, 79)
    elif rand < 0.727739171:
        return random.randint(80, 84)
    elif rand < 0.746413106:
        return random.randint(85, 89)
    elif rand < 0.754098567:
        return random.randint(90, 94)
    elif rand < 0.755803702:
        return random.randint(95, 99)
    elif rand < 0.755803702 + young_percentage:
