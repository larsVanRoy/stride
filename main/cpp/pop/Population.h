...
public:
        ...
        Person* CreatePerson(unsigned int id, double age, unsigned int daycareId, unsigned int preschoolId,
                             unsigned int householdId, unsigned int k12SchoolId, unsigned int collegeId,
