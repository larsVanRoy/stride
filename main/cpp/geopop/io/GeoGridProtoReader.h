...
private:
        ...
        void ParseContactPools(std::shared_ptr<Location<Coordinate>>       loc,
        ...
        std::shared_ptr<Location<Coordinate>> ParseLocation(const proto::GeoGrid_Location& protoLocation);
