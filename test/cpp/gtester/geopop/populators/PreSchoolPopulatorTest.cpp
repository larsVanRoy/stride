...
// */
//
//#include "geopop/populators/PreSchoolPopulator.cpp"
//
//#include "MakeGeoGrid.h"
//#include "contact/AgeBrackets.h"
//#include "geopop/GeoGridConfig.h"
//#include "geopop/Location.h"
//#include "geopop/generators/PreSchoolGenerator.cpp"
...
//        auto& k12Pools = location->RefPools(Id::PreSchool);
//
//        ASSERT_EQ(k12Pools.size(), 5 * m_ppps);
...
//        m_preschool_populator.Apply(m_geo_grid, m_gg_config);
//
//        auto& k12Pools1 = brasschaat->RefPools(Id::PreSchool);
//        auto& k12Pools2 = schoten->RefPools(Id::PreSchool);
//        auto& k12Pools3 = kortrijk->RefPools(Id::PreSchool);
//
//        // Check number of pools corresponding to 3 PreSchools per location.
//        EXPECT_EQ(k12Pools1.size(), 3 * m_ppps);
//        EXPECT_EQ(k12Pools2.size(), 3 * m_ppps);
//        EXPECT_EQ(k12Pools3.size(), 3 * m_ppps);
//
//        map<int, int> persons{
...
//                        const auto k12Id = p->GetPoolId(Id::PreSchool);
