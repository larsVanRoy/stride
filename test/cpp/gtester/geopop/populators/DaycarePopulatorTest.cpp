...
// */
//
//#include "geopop/populators/DaycarePopulator.cpp"
//
//#include "MakeGeoGrid.h"
//#include "contact/AgeBrackets.h"
//#include "geopop/GeoGridConfig.h"
//#include "geopop/Location.h"
//#include "geopop/generators/DaycareGenerator.cpp"
...
//        m_daycare_populator.Apply(m_geo_grid, m_gg_config);
//
//        auto& k12Pools1 = brasschaat->RefPools(Id::Daycare);
//        auto& k12Pools2 = schoten->RefPools(Id::Daycare);
//        auto& k12Pools3 = kortrijk->RefPools(Id::Daycare);
//
//        // Check number of pools corresponding to 3 Daycares per location.
//        EXPECT_EQ(k12Pools1.size(), 3 * m_ppd);
//        EXPECT_EQ(k12Pools2.size(), 3 * m_ppd);
//        EXPECT_EQ(k12Pools3.size(), 3 * m_ppd);
//
//        map<int, int> persons{
...
//                const auto k12Id = p->GetPoolId(Id::Daycare);
