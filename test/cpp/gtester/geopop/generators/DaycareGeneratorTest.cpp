...
//        m_gg_config.info.popcount_daycare = 9000;
//
...
//        EXPECT_EQ(poolsOfLoc1.size(), 3 * m_ppd);
//}
//
...
//        m_gg_config.info.popcount_daycare = 79998;
//
...
//                EXPECT_EQ(expected[i] * m_ppd, m_geo_grid[i]->CRefPools<Id::Daycare>().size());
//        }
//}
//
//} // namespace
