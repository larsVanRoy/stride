...
namespace Tests {
    ...
    tuple<ptree, unsigned int, double> ScenarioData::Get(string tag)
    {
        ...
        const map<string, unsigned int> targets_geopop = {
                ...
                {"r0_12_geopop", 37000U},        {"r0_16_geopop", 65000U},       {"r0_4_geopop", 4300U},
                {"r0_8_geopop", 15000U}};

        const map<string, double> margins_geopop = {{"influenza_a_geopop", 5.0e-01}, {"influenza_b_geopop", 0.0},
                                                    {"influenza_c_geopop", 2.0e-1},  {"measles_16_geopop", 8.0e-01},
                                                    {"measles_26_geopop", 2.0e-03},  {"r0_0_geopop", 2.0e-02},
                                                    {"r0_12_geopop", 5.0e-01},       {"r0_16_geopop", 5.0e-01},
                                                    {"r0_4_geopop", 8.0e-01},        {"r0_8_geopop", 5.0e-01}};
